...
熟练使用快捷键是非常有必要的:     
![use_shortcut](https://gitee.com/xj36/chart-bed-test/raw/master/static/use_shortcut.gif)
...
![auto_import](https://gitee.com/xj36/chart-bed-test/raw/master/static/auto_import.gif)   
你可以快速打开一些设置，例如你想在`finder`中查看该文件，直接输入`find`就好了。
![action_find](https://gitee.com/xj36/chart-bed-test/raw/master/static/action_find.png)   
...
![tab_tip](https://gitee.com/xj36/chart-bed-test/raw/master/static/tab_tip.gif)
...
![command_j](https://gitee.com/xj36/chart-bed-test/raw/master/static/command_j.gif)对于一些更多的模式，在代码自动完成时也支持生成对应的模板，例如使用`Toast`的快捷键可以很方便的生成一个新的`toast`对象，你只需要指定文字就可以了。     
![toast_autocomp](https://gitee.com/xj36/chart-bed-test/raw/master/static/toast_autocomp.gif)        
用`Command+Shift+A`然后输入`live template`然后打开对应的页面，可以看到目前已经存在的模板。当然你也可以添加新的模板。     
![live_templete](https://gitee.com/xj36/chart-bed-test/raw/master/static/live_templete.png)
...
![debug_eva](https://gitee.com/xj36/chart-bed-test/raw/master/static/debug_eva.gif)
...
![structural_search](https://gitee.com/xj36/chart-bed-test/raw/master/static/structural_search.gif)       
